...
// -------------------------------------------------------
	...
	GraphNode<NodeType, ArcType>* m_previousNode;

public:
	//constructor setting node to null
	GraphNode (GraphNode<NodeType, ArcType>* previousNode = NULL) : m_previousNode(previousNode)
	{
	...
	//get function
	GraphNode<NodeType, ArcType>* getPreviousNode() const{
